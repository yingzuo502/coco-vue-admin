    ...
    <div>
        <div class="crumbs">
          <el-breadcrumb separator="/">
              ...
              <el-breadcrumb-item >添加频道</el-breadcrumb-item>
          </el-breadcrumb>
        </div>
        ...
        <el-form :label-position="labelPosition" label-width="340px" :model="formLabelAlign"  v-loading="loading2" element-loading-text="拼命提交中" element-loading-spinner="el-icon-loading"
          element-loading-background="rgba(0, 0, 0, 0.8)">
            ...
            <el-form-item label="*选择APP平台">
              <el-select v-model="formLabelAlign.chooseChannelName"   placeholder="请选择平台">
                      <el-option
                        v-for="item in formLabelAlign.ChannelNameValue"
                         :key="item.value"
                        :label="item.label"
                        :value="item.label">
                      </el-option>
    ...
    methods: {
      onSubmit() {
        ...
        var formLabelAlign_list ={
           formLabelAlign_chooseChannelName :this.formLabelAlign.chooseChannelName,
